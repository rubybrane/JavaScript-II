...
console.log(`${largeShirts.length} runners are size L`); //I wanted to know how many runners of size L
...
let ticketPriceTotal = runners.reduce(function(donation_total, donations){
    return donation_total + donations.donation;
}, 0);
console.log(`${ticketPriceTotal} is the total of ticket sales`);
